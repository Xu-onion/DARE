...
class SwinMAE(nn.Module):
    ...
    def __init__(self, img_size: int = 224, patch_size: int = 1, mask_ratio: float = 0.75, in_chans: int = 3,
    ...
    def window_masking(self, x: torch.Tensor, r: int = 1,
        ...
        # np.int was removed in NumPy 1.24; int64 also matches torch index tensors.
